...
/**
 * This is the item provider adapter for a {@link framework_campeonato.Time} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Time_nome_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Time_nome_feature", "_UI_Time_type"),
				 Framework_campeonatoPackage.Literals.TIME__NOME,
				 true,
				 false,
				 false,
	...
	protected void addCodigoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Time_codigo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Time_codigo_feature", "_UI_Time_type"),
				 Framework_campeonatoPackage.Literals.TIME__CODIGO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Framework_campeonatoPackage.Literals.TIME__JOGADOR);
		}
	...
	public String getText(Object object) {
		String label = ((Time)object).getNome();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Framework_campeonatoPackage.Literals.TIME__JOGADOR,
				 Framework_campeonatoFactory.eINSTANCE.createGoleiro()));

		newChildDescriptors.add
			(createChildParameter
				(Framework_campeonatoPackage.Literals.TIME__JOGADOR,
				 Framework_campeonatoFactory.eINSTANCE.createZagueiro()));

		newChildDescriptors.add
			(createChildParameter
				(Framework_campeonatoPackage.Literals.TIME__JOGADOR,
				 Framework_campeonatoFactory.eINSTANCE.createAtacante()));

		newChildDescriptors.add
			(createChildParameter
				(Framework_campeonatoPackage.Literals.TIME__JOGADOR,
				 Framework_campeonatoFactory.eINSTANCE.createLateral()));
	}
