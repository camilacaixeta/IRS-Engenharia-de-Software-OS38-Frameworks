...
/**
 * This is the item provider adapter for a {@link framework_matricula.Matricula} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MatriculaItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Matricula_codigo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Matricula_codigo_feature", "_UI_Matricula_type"),
				 Framework_matriculaPackage.Literals.MATRICULA__CODIGO,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Framework_matriculaPackage.Literals.MATRICULA__DISCIPLINA);
			childrenFeatures.add(Framework_matriculaPackage.Literals.MATRICULA__TIPO_MATRICULA);
		}
	...
	public String getText(Object object) {
		String label = ((Matricula)object).getCodigo();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Framework_matriculaPackage.Literals.MATRICULA__DISCIPLINA,
				 Framework_matriculaFactory.eINSTANCE.createDisciplina()));

		newChildDescriptors.add
			(createChildParameter
				(Framework_matriculaPackage.Literals.MATRICULA__TIPO_MATRICULA,
				 Framework_matriculaFactory.eINSTANCE.createTipoMatricula()));
	}
