...
/**
 * This is the item provider adapter for a {@link framework_matricula.AlunoComum} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AlunoComumItemProvider 
	 ...
	 * @generated
	 */
	public AlunoComumItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AlunoComum"));
	}
	...
	public String getText(Object object) {
		String label = ((AlunoComum)object).getNome();
		return label == null || label.length() == 0 ?
			getString("_UI_AlunoComum_type") :
			getString("_UI_AlunoComum_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AlunoComum.class)) {
