...
/**
 * This is the item provider adapter for a {@link framework_matricula.Disciplina} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DisciplinaItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAreaConhecimentoPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Disciplina_nome_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Disciplina_nome_feature", "_UI_Disciplina_type"),
				 Framework_matriculaPackage.Literals.DISCIPLINA__NOME,
				 true,
				 false,
				 false,
	...
	protected void addCodigoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Disciplina_codigo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Disciplina_codigo_feature", "_UI_Disciplina_type"),
				 Framework_matriculaPackage.Literals.DISCIPLINA__CODIGO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Area Conhecimento feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAreaConhecimentoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Disciplina_areaConhecimento_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Disciplina_areaConhecimento_feature", "_UI_Disciplina_type"),
				 Framework_matriculaPackage.Literals.DISCIPLINA__AREA_CONHECIMENTO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Integer labelValue = ((Disciplina)object).getCodigo();
