...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Aluno Bolsista</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link framework_matricula.impl.AlunoBolsistaImpl#getNome <em>Nome</em>}</li>
 *   <li>{@link framework_matricula.impl.AlunoBolsistaImpl#getNumeroMatricula <em>Numero Matricula</em>}</li>
 *   <li>{@link framework_matricula.impl.AlunoBolsistaImpl#getDataNascimento <em>Data Nascimento</em>}</li>
 *   <li>{@link framework_matricula.impl.AlunoBolsistaImpl#getMatricula <em>Matricula</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AlunoBolsistaImpl extends MinimalEObjectImpl.Container implements AlunoBolsista {
	/**
	...
	protected EClass eStaticClass() {
		return Framework_matriculaPackage.Literals.ALUNO_BOLSISTA;
	}
	...
	public void setNome(String newNome) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Framework_matriculaPackage.ALUNO_BOLSISTA__NOME, oldNome, nome));
	}
	...
	public void setNumeroMatricula(Integer newNumeroMatricula) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Framework_matriculaPackage.ALUNO_BOLSISTA__NUMERO_MATRICULA, oldNumeroMatricula, numeroMatricula));
	}
	...
	public void setDataNascimento(String newDataNascimento) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Framework_matriculaPackage.ALUNO_BOLSISTA__DATA_NASCIMENTO, oldDataNascimento, dataNascimento));
	}
	...
	public EList<Matricula> getMatricula() {
		if (matricula == null) {
			matricula = new EObjectContainmentEList<Matricula>(Matricula.class, this, Framework_matriculaPackage.ALUNO_BOLSISTA__MATRICULA);
		}
		return matricula;
	}
